...
class ControllerExtensionPaymentNovalnet extends Controller
{
    ...
    public function performCurlProcess($url, $form) {
        $curl_timeout = $this->config->get('payment_novalnet_curl_timeout');
        ...
        $proxy  = trim($this->config->get('payment_novalnet_proxy'));
        $ch     = curl_init($url);

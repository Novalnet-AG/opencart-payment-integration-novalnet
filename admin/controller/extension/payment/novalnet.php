...
class ControllerExtensionPaymentNovalnet extends Controller
{
     ...
     * @return string
     */
    public function prepareNovalnetComments($response, $order_info, $payment_name, $order_id,$payment_id= '')
    {
	$response['invoice_account_holder'] = 'Novalnet AG';	
	    $novalnet_comments = '';
	    if(!empty($payment_id) && in_array($payment_id ,array(40,41)))
	    {
          $novalnet_comments .= $this->language->get('text_guarantee_payment') . '<br/>' ;
	    }

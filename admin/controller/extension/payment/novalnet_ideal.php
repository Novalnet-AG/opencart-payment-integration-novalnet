...
class ControllerExtensionPaymentNovalnetIdeal extends Controller
{
	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {						
			$this->model_extension_payment_novalnet->storeConfigurations('payment_novalnet_ideal');
		}

		// Get template details.
		$data = $this->model_extension_payment_novalnet->getTemplateDetails('novalnet_ideal');
		...
		// Add template.
		$this->response->setOutput($this->load->view('extension/payment/novalnet_ideal', $data));
	}
	...
	public function getConfigurationContent(&$data) {
		foreach (array(
			'payment_novalnet_ideal_status',
			'payment_novalnet_ideal_testmode',
			'payment_novalnet_ideal_buyer_notification',
			'payment_novalnet_ideal_order_completion_status',
			'payment_novalnet_ideal_total',
			'payment_novalnet_ideal_geo_zone_id',
			'payment_novalnet_ideal_sort_order',
		) as $field) {
	...
	public function order() {
		if ($this->config->get('payment_novalnet_ideal_status')) {

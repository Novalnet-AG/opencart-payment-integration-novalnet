...
class ControllerExtensionPaymentNovalnetCc extends Controller
{
	...
	public function getConfigurationContent(&$data) {
		foreach (array(
			...
			'payment_novalnet_cc_force_3d_enable',
			'payment_novalnet_cc_display_amex',
			'payment_novalnet_cc_display_maestro',
	...
	public function recurringButtons() {
		...
		$data['next_subs_cycle'] = $data['subscriptpostion_details']['next_subs_cycle'];

...
$_['entry_product_activation_key_desc']       = 'Get your Product activation key from the Novalnet Admin Portal: Projects > Choose your project > API credentials > API Signature (Product activation key)';

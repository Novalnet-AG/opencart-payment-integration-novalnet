...
class ModelExtensionPaymentNovalnet extends Model
{
    ...
    public function install() {
        ...
        $this->db->query("CREATE TABLE IF NOT EXISTS  " . DB_PREFIX . "novalnet_affiliate_account (
            id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Auto increment ID',
            aff_id int(11) unsigned NOT NULL COMMENT 'Affiliate merchant ID',
            affiliate_configuration text COMMENT 'Affiliate details',
            product_url varchar(200) NOT NULL COMMENT 'Product URL for the affiliate',
        ...
        $this->db->query("CREATE TABLE IF NOT EXISTS  " . DB_PREFIX . "novalnet_affiliate_user (
            id int(11) unsigned NOT NULL AUTO_INCREMENT,
            aff_id int(11) unsigned NOT NULL COMMENT 'Affiliate merchant ID',
            customer_id int(11) unsigned DEFAULT NULL COMMENT 'Affiliate customer ID',
            aff_order_no int(11) NOT NULL COMMENT 'Order ID for the order in shop',
            PRIMARY KEY (id),

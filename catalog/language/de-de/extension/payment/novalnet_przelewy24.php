...
$_['payment_logo']                   = '<img id="novalnet_przelewy24_logo" src="image/payment/novalnet/novalnet_przelewy24.png" alt="Przelewy24" title="Przelewy24" style="width:60px; height:17px;" />';

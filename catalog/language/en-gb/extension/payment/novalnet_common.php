...
$_['text_novalnet_automaticredirection']           = 'After the successful verification, you will be redirected to Novalnet secure order page to proceed with the payment';
...
$_['text_browser_description']                     = 'Please don’t close the browser after successful payment, until you have been redirected back to the Shop';
$_['text_payment_description']                     = 'After the successful verification, you will be redirected to Novalnet secure order page to proceed with the payment';
...
$_['text_fraud_mobile']                            = 'Mobile number';
$_['text_fraud_tel']                               = 'Telephone number';
$_['text_fraud_transaction_pin']                   = 'Transaction PIN';
$_['text_fraud_forgot_pin']                        = 'Forgot your PIN?';
$_['novalnet_fraud_sms_msg']                       = 'You will shortly receive an SMS containing your transaction PIN to complete the payment';
$_['novalnet_fraud_tel_msg']                       = 'You will shortly receive a transaction PIN through phone call to complete the payment';
$_['error_pin_empty']                              = 'Enter your PIN';
$_['error_pin_not_valid']                          = 'The PIN you entered is incorrect';
